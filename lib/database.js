        ...
        return new Promise((resolve, reject) => {
            this.db().serialize(() => {
                this.db()
                    ...
                    .run('CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, phone TEXT NOT NULL, username TEXT NOT NULL, password TEXT NOT NULL, email TEXT NOT NULL, birthdate DATETIME NOT NULL);', (t, err) => {
                        resolve();
                    });
            });
        });
